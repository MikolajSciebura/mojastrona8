...
$router->add('GET', '/konfigurator/drukuj', 'ConfiguratorController@print');
$router->add('GET', '/serwis', 'ShopController@service');
$router->add('GET', '/serwis/status', 'ServiceController@status');
...
$router->add('GET', '/admin/produkty/edytuj/{id}', 'AdminController@productsEdit');
$router->add('POST', '/admin/produkty/update/{id}', 'AdminController@productsUpdate');
$router->add('GET', '/admin/produkty/usun/{id}', 'AdminController@productsDelete');
...
$router->add('POST', '/admin/serwis/status', 'AdminController@updateRepairStatus');
